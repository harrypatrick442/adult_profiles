module.exports = (function(){
	...
	Core.Linq;
	return function(profileRepository, profilePropertyNames){
		if(!profileRepository)throw new Error('No profileRepository provided');
		if(!profilePropertyNames)throw new Error('No profilePropertyNames provided');
